                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">United States of America</h3>
                ...
                <div class="col-md-12" style="padding:20px;">
                            ...
                            <div class="col-md-12 padding-0">
                                    ...
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                        <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                          <h4 class="text-left">Active Contracts</h4>
                                        </div>
                                      ...
                                      <div class="panel-body text-center">
                                        <h1>3</h1>
                                        <p>Crop Insurance | Life Insurance | Draught Insurance</p>
                                        <hr/>
                                      </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="panel box-v1">
                                      ...
                                      <div class="panel-body text-center">
                                        <h1>$27</h1>
                                        <p>Bank of America - Crop Insurance (25<sup>th</sup> June)</p>
                                        <hr/>
                                      </div>
                                    </div>
                                </div>
                  ...
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="post" action="/createContract.php">
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="firstname" name="firstname" required>
                              <span class="bar"></span>
                              <label>Firstname</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="lastname" name="lastname" required>
                              <span class="bar"></span>
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="bank_name" name="bank_name" required>
                              <span class="bar"></span>
                              <label>Name of the Bank</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="bank_contract" name="bank_contract" required>
                              <span class="bar"></span>
                              <label>Contract with the Bank</label>
                            </div>
